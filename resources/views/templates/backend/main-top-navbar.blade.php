...
<head>
    ...
    <title>Pandoradev - @yield('title')</title>
    <link rel="shortcut icon" href="{{ asset('template-backend/assets/compiled/svg/favicon.svg') }}" type="image/x-icon">
...
<body>
    <script src="{{ asset('template-backend/assets') }}/static/js/initTheme.js"></script>
    <div id="app">
        <div id="main" class="layout-horizontal">
                            ...
                            <div class="dropdown">
                                <a href="#" id="topbarUserDropdown" class="user-dropdown d-flex align-items-center dropend dropdown-toggle " data-bs-toggle="dropdown" aria-expanded="false">
                                    <div class="avatar avatar-md2">
                                        <img src="{{ asset('template-backend/assets') }}/compiled/jpg/1.jpg" alt="Avatar">
                                    </div>
                                    <div class="text">
            ...
            @include('templates.backend.partial-footer')
        </div>
    </div>
    ...
    <script src="{{ asset('template-backend/assets') }}/static/js/pages/horizontal-layout.js"></script>
    ...
    {{-- <script src="{{ asset('template-backend/assets') }}/extensions/apexcharts/apexcharts.min.js"></script> --}}
    <script src="{{ asset('template-backend/assets') }}/static/js/pages/dashboard.js"></script>
